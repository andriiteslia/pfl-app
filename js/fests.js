...
import { $, $$, escapeHtml, setButtonLoading, haptic } from './utils.js';
...
const DATA_2025 = {
  ...
  predator2: [
    ...
    ['1', 'Fusion два і пять\n(Боженко Н, Свердел Т)', '9', '5436'],
    ['2', 'Jig Brothers\n(Бернацький Ю, В)', '15', '2530'],
    ['3', 'Сірі кепки Simms\n(Предзимірський А, Сало Д)', '18', '3759'],
    ['4', 'Удар\n(Лучко В, Хайпре О)', '20', '2542'],
    ['5', 'Опілля\n(Стефінів А, Григорів Д)', '22', '2209'],
    ['6', 'Чарівні Озера\n(Гавдан Б, Пасєка С)', '25', '1808'],
    ['7', 'Twin Power\n(Мелець А, Тесля А)', '27', '2051'],
    ['8', 'MadFish Golden Catch\n(Столяр Б, Дмитрів В)', '30', '1723'],
    ['9', 'Два Окуня\n(Хомин Н, Александрук А)', '31', '1688'],
    ['10', 'Predator\n(Томілов С, Донець В)', '34', '1391'],
    ['11', 'Гострі Картузи\n(Гутий Ю, Козак Н)', '35', '1326'],
    ['12', 'Сусіди\n(Крокіс Д, Лега Р)', '48', '667'],
    ['13', 'Cool Dude\n(Маринчук О, Худоба В)', '52', '358'],
    ['14', 'РОДА\n(Марусяк Ю, Маєцький А)', '60', '132'],
    ['15', "AL'S Barbershop\n(Мороз В, Аллахвердієв Азар)", '65', '33'],
    ['16', "Hloviakfamily\n(Глов'як Назар та Вікторія)", '68', '0'],
  ],
